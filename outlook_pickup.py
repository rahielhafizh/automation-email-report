...
def send_outlook_email(
    ...
    logger.info("[SYSTEM] START REPPO/PICKUP REPORT MAIL")
    ...
    try:
        ...
        wait_timer(CONFIG["WAIT_TIME"]["ONE_SECOND"])
        finish_outlook()
        logger.info("[SYSTEM] REPPO/PICKUP REPORT MAIL COMPLETED")

    except Exception as e:
        logger.error(f"[ERROR] REPPO/PICKUP REPORT MAIL FAILED : {e}")
        raise
