...
def send_outlook_email(
    ...
    logger.info("[SYSTEM] START MOBCOLL REGULER REPORT MAIL")
    ...
    try:
        ...
        logger.info("[SYSTEM] MOBCOLL REGULER REPORT MAIL COMPLETED")

    except Exception as e:
        logger.error(f"[ERROR] MOBCOLL REGULER REPORT MAIL FAILED : {e}")
        raise
