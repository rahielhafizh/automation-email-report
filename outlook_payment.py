...
def send_outlook_email(
    ...
    logger.info("[SYSTEM] START INSTALLMENT PAYMENT REPORT MAIL")
    ...
    try:
        ...
        logger.info("[SYSTEM] INSTALLMENT PAYMENT REPORT MAIL COMPLETED")

    except Exception as e:
        logger.error(f"[ERROR] INSTALLMENT PAYMENT REPORT FAILED : {e}")
        raise
