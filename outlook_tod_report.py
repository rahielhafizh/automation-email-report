...
def send_outlook_email(
    ...
    logger.info("[SYSTEM] START SUMMARY PERFORMANCE TOD MAIL")
    ...
    try:
        ...
        if isinstance(outlook_recipients, str):
            ...
            raise TypeError("OUTLOOK RECIPIENTS MUST BE STRING OR LIST")
        ...
        wait_timer(CONFIG["WAIT_TIME"]["ONE_SECOND"])
        finish_outlook()
        logger.info("[SYSTEM] SUMMARY PERFORMANCE TOD MAIL COMPETED")

    except Exception as e:
        logger.error(f"[ERROR] SUMMARY PERFORMANCE TOD FAILED : {e}")
        raise
