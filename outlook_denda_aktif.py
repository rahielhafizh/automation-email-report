...
def send_outlook_email(
    ...
    logger.info("[SYSTEM] START ACTIVE FINE REPORT MAIL")
    ...
    try:
        ...
        wait_timer(CONFIG["WAIT_TIME"]["ONE_SECOND"])
        finish_outlook()
        logger.info("[SYSTEM] ACTIVE FINE REPORT MAIL COMPLETED")

    except Exception as e:
        logger.error(f"[ERROR] ACTIVE FINE REPORT MAIL FAILED : {e}")
        raise
